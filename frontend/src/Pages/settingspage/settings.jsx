  ...
  const handleClick = async (type)=>{
    ...
    return   (
      <div className="bg-white h-full w-full relative overflow-hidden">
        ...
        <Button clickHandler={()=>setData({showMoreInfo: true, info: 'Acknowledgements info', type:'Acknowledgements'})} text="Tillkännagivanden" icon={AchievementsIcon} size="large"></Button>
