          ...
          <div className='w-5/6'>
            <div className='mb-10'>
              <label className='w-full text-center flex border-4 border-primaryDark rounded-lg mb-5'>
                ...
                <input className='w-full p-2 outline-none' type="text" onChange={(e)=>setInputUsername(e.target.value)} />
              </label>
              <label className='w-full text-center flex border-4 border-primaryDark rounded-lg'>
                ...
                <input className='w-full p-2 outline-none' type="password" onChange={(e)=>setInputPassword(e.target.value)}/>
              </label>
            </div>
            <div className='w-full text-center flex justify-around'>
              <button 
                className=' bg-primaryDark text-white rounded-md' 
                style={{ border: 'none', padding: '15px 32px', textAlign: 'center', textDecoration: 'none', display: 'inline-block'}} 
                onClick={()=>handleLogin()}>Login</button>
              
              <button 
                className=' bg-primaryDark text-white rounded-md' 
                style={{ border: 'none', padding: '15px 32px', textAlign: 'center', textDecoration: 'none', display: 'inline-block'}} 
                onClick={()=>handleCreateAccount()}>Signup</button>
            </div>
          </div>
        </div>
      </div>
